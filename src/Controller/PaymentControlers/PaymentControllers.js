...
exports.postOrder =  async (req, res) => {
    ...
    const data = {
      ...
      successUrl: `http://localhost:5000/api/v1/success?tran_id=${tran_id}&email=${userEmail}`,
  ...
  exports.postSuccess = async (req, res) => {
    ...
    if(updateOrder.modifiedCount >= 1){
        ...
        res.redirect("http://localhost:3000/dashboard/my-orders") // TODO: after deploy then set live link
    }
